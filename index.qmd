...
computation of H2’to networks of the same absolute size per gridcell,
...
computing expected values of FTA and H2’. To do this for a given
...
species set, we used the same procedures to calculate FTA and H2’ and
replicated the process 999 independent times to obtain a distribution of
expected FTA and H2’ values. Finally, we computed the deviance between
...
annual temperature) ( 𝞫 =0.0051, p=0.859), Prec (Total annual
...
differentiation of interaction niches @durand2023trait . Our linear
model highlights Precipitation Seasonality as a key factor influencing
Functional Trophic Asymmetry (FTA) across SBM groupings. This suggests
...
not all trait combinations align optimally with the global preferences
of their co-occurring interaction partners, thus contributing to promote
structural diversity in seed dispersal networks across Neotropical
sites. For example, mammalian frugivores, which can exhibit a broad
...
availability. Consequently, this ecological scenario is expected to
result in increased FTA, driven by the restricted functional richness of
available resources for consumers. Similarly, palms with larger fruit
...
mammal diversity and endemism. @webb2006great; @whiteman2015into
...
probabilities from trait matching and range co-occurrences \[
@pena2023abundance, @donoso2017complementary, @mcfadden2022global\]
...
mymod <- readRDS("C:/Users/gabri/Documents/PhD/00_Chapter_palms_mammal_interactions/R-analisis/00_Data/04_models/lm_asym_all.RDS")
...
mymod <- readRDS("C:/Users/gabri/Documents/PhD/00_Chapter_palms_mammal_interactions/R-analisis/00_Data/04_models/obs_model1.RDS")
...
to the implications of changing FTA on network specialization—a measure
...
![**(A)** Heatmap depicting the interaction probability among various
...
seasonality.](Main_figures/00_network_fr.png){fig-align="center"}

## Figure 3

![Spatial distribution of **(A)** FTA z-score (mean) and **(B)** H2'
...
the Southern
Cone.](Main_figures/00_network_maps.tif.png){fig-align="center"}
